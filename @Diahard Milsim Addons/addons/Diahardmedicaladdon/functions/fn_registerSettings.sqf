[
    "DMA_EmergencyTraumaDressing_Speed",
    "SLIDER",
    [
        "Emergency Trauma Dressing speed",
        "Speed at which the bandage is applied Lower is better."
    ],
    [
        "DMA Medical",
        "Bandages"
    ...
    {
        params ["_value"];
        missionNamespace setVariable ["DMA_EmergencyTraumaDressing_Speed", _value];
    }
...
[
    ...
    [
        "Chitosan Speed",
        "Speed at which the Chitosan is applied Lower is better."
    ],
    [
        "DMA Medical",
        "Bandages"
    ...
    {
        params ["_value"];
        missionNamespace setVariable ["DMA_Chitosan_Speed", _value];
    }
] call CBA_fnc_addSetting;
...
missionNamespace setVariable ["DMA_EmergencyTraumaDressing_Speed", missionNamespace getVariable ["DMA_EmergencyTraumaDressing_Speed", 10]];
missionNamespace setVariable ["DMA_Chitosan_Speed", missionNamespace getVariable ["DMA_Chitosan_Speed", 10]];